                        ...
                        <Row>
                            <Col lg={{ span: 8, offset: 2 }} md={12} xs={12} className="text-center">
                                <Row className="plm-nav my-4 g-0">
                                    <Col xs={3}>
                                        <button onClick={() => this.setState({ planModalShow: true })} className="btn btn-link direction-btn p-0">Plan</button>
                                    </Col>
                                    <Col xs={3}>
                                        <button onClick={() => this.setState({ executeModalShow: true })} className="btn btn-link direction-btn p-0">Execute</button>
                                    </Col>
                                    <Col xs={3}>
                                        <button onClick={() => this.setState({ measureModalShow: true })} className="btn btn-link direction-btn p-0">Measure</button>
                                    </Col>
                                    <Col xs={3}>
                                        <button onClick={() => this.setState({ warmUPModalShow: true })} className="btn btn-link direction-btn p-0">Warm Up</button>
                                    </Col>
                                </Row>
                            </Col>
