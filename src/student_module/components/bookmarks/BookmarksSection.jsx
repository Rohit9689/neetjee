...
import ImportentAlert from "./ImportentAlert";
...
class BookmarksSection extends Component {
    ...
    className = (data) => {
        let classname = "";
        if (data == "Botany") {
            classname = "bg-img botnay_img";
        }
        else if (data == "Physics") {
            classname = "bg-img physics_img";
        }
        else if (data == "Chemistry") {
            classname = "bg-img chemistry_img";
        }
        else if (data == "Zoology") {
            classname = "bg-img zoology_img";
        }
        else if (data == "Mathematics") {
            classname = "bg-img maths_img";
        }
        return classname;

    }
    countModalFunction = (e, data, type) => {
        console.log("countModalFunction", e, data, type);
        if (data > 0) {
    ...
    render() {
        const tagdata = this.props.studentGlobals.tags.filter((a) => a.count > 0);
        const isuserValid = JSON.parse(this.props.isStudentUserValid.user_access_restictions);
        console.log("isuserValid", isuserValid);
        if (isuserValid.bookmarks_tab == true) {
            return (
                        ...
                        <Col xl={12} lg={12} md={12} sm={12}>
                            <div className="text-center">
                                ...
                                <h5 className="text-danger">
                                    Dear Student your bookmark pack is expired. To get full access purchase now
                                    </h5>
                            </div>
            ...
            return (
                <div className="bookmarks_section">
                   <Row className="mt-4 type-wise-list">
                        ...
                        {/* <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            <Link
                                ...
                                <Card className="signle_card border-0 shadow-sm h-100">
                                    <Card.Header className="d-flex align-items-center border-0 shadow-sm text-primary">
                                        <div className="icon mr-2">
                                            <i className="fad fa-video fa-fw fa-2x" />
                                        </div>
                                        <Card.Title className="mb-0 h6">Videos</Card.Title>
                                    </Card.Header>
                                    <Card.Body className="p-3">
                                        <Card.Title className="mb-0">{this.props.getStudentBookmarksCount.video_count}</Card.Title>
                                    </Card.Body>
                                </Card>
                            </Link>
                        </Col> */}
                        <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            ...
                            style={{cursor:"pointer"}}
                                onClick={(e) => this.countModalFunction(e, this.props.getStudentBookmarksCount.short_notes_count, "/student/bookmark/shortnotes-and-materials")}
                                className="signle_card border-0 shadow-sm h-100">
                                <Card.Header className="d-flex align-items-center border-0 shadow-sm text-success">
                                    <div className="icon mr-2">
                                        <i className="fad fa-clipboard fa-fw fa-2x" />
                                    </div>
                                    <Card.Title className="mb-0 h6">Short notes & Revision Mateterial</Card.Title>
                                </Card.Header>
                                <Card.Body className="p-3">
                                    <Card.Title className="mb-0">{this.props.getStudentBookmarksCount.short_notes_count}</Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            <Card
                            style={{cursor:"pointer"}}
                                onClick={(e) => this.countModalFunction(e, this.props.getStudentBookmarksCount.practice_questions_count, "/student/bookmark/practice-questions")}
                                className="signle_card border-0 shadow-sm h-100">
                                <Card.Header className="d-flex align-items-center border-0 shadow-sm text-warning">
                                    <div className="icon mr-2">
                                        <i className="fad fa-question-circle fa-fw fa-2x" />
                                    </div>
                                    <Card.Title className="mb-0 h6">Practise <br />Questions</Card.Title>
                                </Card.Header>
                                <Card.Body className="p-3">
                                    <Card.Title className="mb-0">{this.props.getStudentBookmarksCount.practice_questions_count}</Card.Title>
                                </Card.Body>
                            </Card>
                        ...
                        <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            ...
                            <Card
                            style={{cursor:"pointer"}}
                                onClick={(e) => this.countModalFunction(e, this.props.getStudentBookmarksCount.exam_questions_count, "/student/bookmark/exam-questions")}
                                className="signle_card border-0 shadow-sm h-100">
                                <Card.Header className="d-flex align-items-center border-0 shadow-sm text-danger">
                                    <div className="icon mr-2">
                                        <i className="fad fa-question-circle fa-fw fa-2x" />
                                    </div>
                                    <Card.Title className="mb-0 h6">Exam <br />Questions</Card.Title>
                                </Card.Header>
                                <Card.Body className="p-3">
                                    <Card.Title className="mb-0">{this.props.getStudentBookmarksCount.exam_questions_count}</Card.Title>
                                </Card.Body>
                            </Card>
                    ...
                    <Row className="mt-4">
                        ...
                        {this.props.getStudentBookmarksCount.bookmark_subjects_count.map((getData) => (
                            <Col xl={3} lg={3} md={6} sm={6} xs={12}>
                                <Card className="singlecard border-0 shadow-sm"
                                    onClick={(e) => this.subjectCountModal(getData)}
                                    style={{cursor:"pointer"}}
                                >
                                    <div className={this.className(getData.subject_name)}></div>
                                    <div className="content d-flex align-items-center">
                                        <div className="icon">
                                            {this.classNameIcon(getData.subject_name)}
                                        </div>
                                        <div className="content-block2 pl-4 d-flex align-items-center">
                                            <h5 className="mb-0">{getData.subject_name}</h5>
                                            <h5 className="pl-4 mb-0 text-white font-weight-bold">{getData.count} </h5>
                                        </div>
                                    </div>
                                </Card>
                            </Col>
                                    ...
                                    if (getData.type == "bookmark") {
                                        return (
                                            <li className="list-inline-item">
                                                ...
                                                >
                                                    {getData.tag}
                                                    <span className="ml-2 font-weight-bold">{getData.count}</span>
                                                </Link>
                                            </li>
                                        )
