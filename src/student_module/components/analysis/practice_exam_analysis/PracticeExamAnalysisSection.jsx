...
class PracticeExamAnalysisSection extends Component {
    ...
    startPractise = (chitemid, itemsubject_id, enabled) => {
        ...
        console.log("moduleValid",moduleValid);

       // if (enabled == true) {
        if ((enabled == true && moduleValid.analysis_tab == false) || isStudentUserValid.chapter_ids.split(",").includes(chitemid.toString())) {
                                                                    ...
                                                                    return (
                                                                        <Card as={Card.Body} className="single-card p-2 mb-2">
                                                                            <div className="d-flex justify-content-between align-items-center pb-2 mb-2">
                                                                                ...
                                                                                <Link
                                                                                    onClick={() => this.startPractise(chitem.id, item.subject_id, chData.enabled)}
