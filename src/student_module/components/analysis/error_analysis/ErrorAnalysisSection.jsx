...
import { Row, Col, Card, CardGroup, ListGroup, Button, Table } from 'react-bootstrap'
import AnalysisFilter from '../AnalysisFilter'
import BarChart from './BarChart';
import VerticalBarChart from './VerticalBarChart';

import './_erroranalysis.scss'

class ErrorAnalysisSection extends Component {
    constructor(props) {
        super(props);
        this.state = {
            practiceTitle: {
    ...
    render() {
        ...
        return (
            <div className="error-analysis pt-4">
                <AnalysisFilter />
                <Card as={Card.Body} className="error-status px-3 py-0 my-3">
                    <Row>
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <Card className="single-status p-2 my-3">
                                <ul className="list-unstyled error-list-one">
                                    <li className="d-flex justify-content-between align-items-center">
                                        <div className="title">Total Wrong Answered</div>
                                        <div className="coluns">:</div>
                                        <div className="count">200</div>
                                    </li>
                                    <li className="d-flex justify-content-between align-items-center">
                                        <div className="title">Total Skipped</div>
                                        <div className="coluns">:</div>
                                        <div className="count">200</div>
                                    </li>
                                    <li className="d-flex justify-content-between align-items-center">
                                        <div className="title">Wrong Corrected</div>
                                        <div className="coluns">:</div>
                        ...
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <Card className="single-status p-2 my-3">
                                ...
                                <Card.Body className="p-0">
                                    <ul className="list-unstyled error-list-two pt-3">
                                        <li className="d-flex justify-content-between align-items-center">
                                            <div className="title">Total Wrong Answered</div>
                                            <div className="count">100</div>
                                            <div className="count">100</div>
                                        ...
                                        <li className="d-flex justify-content-between align-items-center">
                                            <div className="title">Wrong Corrected</div>
                                            <div className="count">
                                                <p>50 <span className="text-primary">25%</span></p>
                                            </div>
                                            <div className="count">
                                                <p>50 <span className="text-primary">25%</span></p>
                                            </div>
                        ...
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <Card className="single-status p-2 my-3">
                                ...
                                <Card.Body className="p-0">
                                    <ul className="list-unstyled error-list-three pt-3">
                                        <li className="d-flex justify-content-between align-items-center">
                                            <div className="title">Total Wrong Answered</div>
                                            <div className="count">100</div>
                                            <div className="count">100</div>
                ...
                <Row>
                    <Col xl={5} lg={12} md={12} sm={12}>
                        <Card className="time-error my-3">
                            ...
                            <Card.Body className="p-2">
                                <Row>
                                    <Col xs={10}>
                                        <BarChart titleHeading={this.state.practiceTitle} />
                                        <BarChart titleHeading={this.state.examTitle} />
                                    </Col>
                    ...
                    <Col xl={7} lg={12} md={12} sm={12}>
                        <Card className="exam-wise my-3">
                            <Card.Header>
                                <h6 className="mb-0 title">Exam Wise</h6>
                            </Card.Header>
                            <Card.Body className="p-0">
                                <CardGroup>
                                    <Card>
                                        ...
                                        <Card.Body className="p-0">
                                            <Table borderless className="exam-wise-table mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>Complexity</th>
                                                        <th>Accuracy</th>
                ...
                <Row>
                    <Col xl={12} lg={12} md={12} sm={12}>
                        <Card className="syllabus-errors my-3">
                            <Card.Header className="bg-white border-0">
                                <h6 className="card-title mb-0">Syllabus vs errors</h6>
                            </Card.Header>
                            <Card.Body className="p-0">
                                <Table bordered responsive className="mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div className="icon d-flex align-items-center">
                                                    ...
                                                    <p className="d-xl-block d-lg-block d-none ml-xl-2 ml-lg-2">Botany</p>
                                                </div>
                                            </th>
                                            <th>
                                                <div className="icon d-flex align-items-center">
                                                    ...
                                                    <p className="d-xl-block d-lg-block d-none ml-xl-2 ml-lg-2">Zoology</p>
                                                </div>
                                            </th>
                                            <th>
                                                <div className="icon d-flex align-items-center">
                                                    ...
                                                    <p className="d-xl-block d-lg-block d-none ml-xl-2 ml-lg-2">Physics</p>
                                                </div>
                                            </th>
                                            <th>
                                                <div className="icon d-flex align-items-center">
                                                    ...
                                                    <p className="d-xl-block d-lg-block d-none ml-xl-2 ml-lg-2">Chemeistry</p>
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="color-bg">
                                                    50 <span className="text-primary ml-2">25%</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="color-bg">
                    ...
                    <Col xl={12} lg={12} md={12} sm={12}>
                        <Card className="syllabus-status my-3">
                            ...
                            <Card.Body className="p-0">
                                <CardGroup>
                                    <Card>
                                        <Card.Header className="bg-white">Botany</Card.Header>
                                        <Card.Body className="p-2">
                                            <ListGroup variant="flush">
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <h6 className="font-weight-normal">Total Chapters</h6>
                                                    <Button variant="dark">32</Button>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                ...
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>100%</p>
                                                    <p><Link to="#">1 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>90 - 99%</p>
                                                    <p><Link to="#">3 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>70- 90%</p>
                                                    <p><Link to="#">9 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>50-70%</p>
                                                    <p><Link to="#">2 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>30 - 50%</p>
                                                    <p><Link to="#">4 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>10- 30%</p>
                                                    <p><Link to="#">1 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                ...
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <p>Not Started</p>
                                                    <p><Link to="#">5 <i className="ml-3 fal fa-angle-right" /></Link></p>
                                                </ListGroup.Item>
                                            </ListGroup>
                                        </Card.Body>
                                    </Card>
                                    <Card>
                                        <Card.Header className="bg-white">Zoology</Card.Header>
                                        <Card.Body className="p-2">
                                            <ListGroup variant="flush">
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <h6 className="font-weight-normal">Total Chapters</h6>
                                    ...
                                    <Card>
                                        <Card.Header className="bg-white">Physics</Card.Header>
                                        <Card.Body className="p-2">
                                            <ListGroup variant="flush">
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <h6 className="font-weight-normal">Total Chapters</h6>
                                    ...
                                    <Card>
                                        <Card.Header className="bg-white">Chemistry</Card.Header>
                                        <Card.Body className="p-2">
                                            <ListGroup variant="flush">
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <h6 className="font-weight-normal">Total Chapters</h6>
...
export default ErrorAnalysisSection
