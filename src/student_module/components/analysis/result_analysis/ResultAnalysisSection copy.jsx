...
class ResultAnalysisSection extends Component {
    ...
    class11(data) {
        console.log("class11class11",this.props.stateData.exam_type);
        let sumper = "";
        ...
        if(this.props.stateData.exam_type=="0,1"){
            ...
            sumper = Math.round(pgetData.class1_accuracy);
        }
        else if(this.props.stateData.exam_type=="1"){
            sumper = Math.round(egetData.class1_accuracy);
        }
    ...
    class12(data) {
        ...
        sumper = Math.round(pgetData.class2_accuracy);
    }
    else if(this.props.stateData.exam_type=="1"){
        sumper = Math.round(egetData.class2_accuracy);
    }
        return sumper;
    }
    learnnowFun = () => {
                            ...
                            <Col xl={4} lg={6} md={12} sm={12}>
                                ...
                                {isuserValid.ra_actions == false ? (
                                    <Card className="action border-0 my-3">
                                        <Card.Body>
                                            ...
                                            <div className="status d-flex mt-3">
                                                ...
                                                <div className="content ml-4">
                                                    ...
                                                    <p className="text-gray4 font-weight-normal">Overall Accuracy</p>
                                        ...
                                        <Card as={Card.Body} className="action border-0 my-3 align-items-center" style={{ height: '17.5rem' }}>
                                ...
                                {isuserValid.ra_overall == false ? (
                                    <Card
                                        ...
                                        className="overall border-0 my-3 text-decoration-none text-dark">
                                ...
                                {isuserValid.ra_time_analysis == false ? (
                                    <Card
                                        ...
                                        className="timeAnalysis border-0 my-3 text-decoration-none text-dark">
                                        <Card.Body className="p-2">
                                                ...
                                                <Table borderless className="ml-5">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Speed</td>
                                                            <th></th>
                                                            <th>{getAnalytics.getAnalytics.time_analysis.speed!=null?(getAnalytics.getAnalytics.time_analysis.speed):("0")} Sec / Per Q</th>
                                                        </tr>
                                                    </tbody>
                                                </Table>
                                            </div>
                            ...
                            <Col xl={8} lg={6} md={12} sm={12}>
                                ...
                                {isuserValid.ra_subject_strength == false ? (
                                    <Card
                                        ...
                                        className="subjectStength border-0 my-3 text-decoration-none text-dark">
                                ...
                                <Row>
                                    {isuserValid.ra_complexity == false ? (
                                        <Col xl={7} lg={6} md={12} sm={12}>
                                            <Link className="text-decoration-none text-dark"
                                                ...
                                                <Card
                                                    as={Card.Body} className="complexityStrength border-0 my-2 p-2">
                                                    <div className="chart-block">
                                                        <ColumnChartTwo
                                            ...
                                            <Col xl={7} lg={6} md={12} sm={12}>
                                                <Card className="complexityStrength border-0 my-2 p-2" style={{ height: '13rem' }}>
                                                    <Card.Body>
                                    ...
                                    {isuserValid.ra_qtheory == false ? (
                                        <Col xl={5} lg={6} md={12} sm={12}>
                                            <Card
                                                className="questionTheory border-0 my-2">
                                            ...
                                            <Col xl={5} lg={6} md={12} sm={12}>
                                                <Card className="questionTheory border-0 my-2" style={{ height: '13rem' }}>
                                ...
                                {isuserValid.ra_qtype == false ? (
                                    <Card
                                        ...
                                        className="questionTypes border-0 my-3 text-decoration-none text-dark">
                                        <Card.Header className="bg-white">
                                            <h6 className="mb-0">You are weak in below listed question types</h6>
                                        </Card.Header>
                                        <Card.Body className="p-2" style={{ height: 260, overflowY: 'auto' }}>
                                            <div className="d-flex align-items-center">
                                                <p className="rotateTxt">Question Types</p>
                                                <ul className="content w-100 list-unstyled">
                                                                ...
                                                                <div className="d-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <div className="w-50">
                                                                        <div className="d-flex mb-1">
                                                                            ...
                                                                            <p className="ml-4 font-weight-bold w-25">{item.accuracy}%</p>
                                                                        </div>
                                                                        {/* {this.props.seperationType == "student" ? (
                                                                        <Button
                                                                    ...
                                                                    <div className="right w-50">
                                                                        <div className="d-flex mb-1">
                                                                            <p className="text-gray4 font-weight-normal">Total Questions</p>
                                                                            <p className="ml-4 font-weight-bold w-25">{item.count}</p>
                                                                        </div>
