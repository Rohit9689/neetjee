...
import ComplexityStrength from "./ComplexityStrength"
...
class ResultAnalysisSection extends Component {
    ...
    render() {
        ...
        console.log("getAnalytics", getAnalytics.getAnalytics);
        if (isuserValid.analysis_tab == true) {
            return (
                <div className="result-analysis py-4">
                    <Row>
            ...
            return (
                <div className="result-analysis py-4">
                    ...
                    <Row>
                        <Col xl={2} lg={6} md={6} sm={6} xs={6} className="my-3 order-xl-1 order-2">
                            {isuserValid.ra_overall == false ? (
                                <Link to={{
                                    pathname: "/student/practice-exam-analysis"
                                }} className="text-decoration-none text-dark">
                                    <Card className="overall-accureny border-0 h-100">
                                        <Card.Body className="content p-2 pt-3">
                                            ...
                                            <Card className="border-darkblue ml-3 h-100">
                                                <Card.Body className="p-2 pt-3 d-flex flex-column justify-content-start">
                                                    <small>Accuracy</small>
                                                    <h3 className="title my-2">{getAnalytics.getAnalytics.strength}%</h3>
                                                    {/* <p className="subtitle">{this.totalPractiseExamQuestions(getAnalytics.getAnalytics.total_practice, getAnalytics.getAnalytics.total_exams, this.props.stateData.exam_type)} Questions</p> */}
                                                </Card.Body>
                                            </Card>
                                        </Card.Body>
                                    </Card>
                        ...
                        <Col xl={8} lg={12} md={12} sm={12} xs={12} className="my-3 order-xl-2 order-1">
                            {isuserValid.ra_subject_strength == false ? (
                                <Link to={{
                                    pathname: "/student/strength-analysis"
                                }} className="text-decoration-none text-dark ">
                                    <Card as={Card.Body} className="p-2 pt-3 subject-accureny border-0">
                                        <div className="title-block">
                                            <div className="title">Subject wise Accuracy</div>
                                        </div>
                                        <div className="indicator">
                                            <i className="fas fa-expand-arrows-alt"></i> Expand to view more
                        </div>
                                        <Row className="g-0 "  className="ml-3">
                                            {
                                                getAnalytics.getAnalytics.subject_strength.map((item, index) => {
                                                    const lowercase = item.subject.toLowerCase();
                                                    return (
                                                        <Col key={index}>
                                                            <Card className={`p-2 text-white border-0 ${lowercase}`}>
                                                                <ul className="list-unstyled m-0 p-0">
                                                                    <li>
                                                                        <small>Accuracy</small>
                                                                        <h3 className="mb-0">{item.strength}%</h3>
                                                                        <p className="mb-0">{item.total_questions} <br /><small>Questions</small></p>
                                                                    </li>
                                                                    <li>
                                                                        <div className="content d-flex flex-column align-items-end justify-content-end">
                                                                            <div className="suject-icon">
                                                                                {this.iconFun(lowercase)}
                                                                            </div>
                                    ...
                                    <Card className="p-2 pt-3 subject-accureny border-0">
                                        <Card.Body >
                        ...
                        <Col xl={2} lg={6} md={6} sm={6} xs={6} className="my-3 order-xl-3 order-3">
                            {isuserValid.ra_time_analysis == false ? (
                                <Link to={{
                                    pathname: "/student/time-analysis",
                                    state: {
                                        time_analysis: getAnalytics.getAnalytics.time_analysis
                                    }
                                }} className="text-decoration-none text-dark">
                                    <Card className="timeAnalysis border-0 h-100">
                                        ...
                                        <Card.Body className="p-2">
                                            <div className="d-flex align-items-start">
                                                <div className="txt-block">
                                                    <div className="rotateTxt">Time Analysis</div>
                                                </div>
                                            </div>
                                            <div className="pl-4 pt-4 content d-flex flex-column align-items-start justify-content-start">
                                                <small>Average Time</small>
                                                <div className="title2 my-2">{getAnalytics.getAnalytics.time_analysis.speed != null ? (getAnalytics.getAnalytics.time_analysis.speed) : ("0")}</div>
                                                <div className="subtitle">Sec/ Question</div>
                                            </div>
                                            {/* <ul className="list-unstyled m-0 p-0 pl-3">
                                        <li>
                                            <small>Average Time</small>
                                            <h3 className="mb-0">Speed</h3>
                                        </li>
                                        <li className="mt-4">
                                            <div className="pt-3 content d-flex flex-column align-items-end justify-content-end">
                                                <div className="title2 h3 mb-0">{getAnalytics.getAnalytics.time_analysis.speed != null ? (getAnalytics.getAnalytics.time_analysis.speed) : ("0")}</div>
                                                <div className="subtitle">Sec/ Question</div>
                                            </div>
                                        </li>
                                    </ul> */}
                    ...
                    <Row className="complexity-accuracy">
                        <Col xl={6} lg={6} md={12} className="my-3">
                            {isuserValid.ra_complexity == false ? (
                                ...
                                <ComplexityStrength
                                    ...
                                    <Card as={Card.Body} className="pt-3 complexity-accuracy-table border-0 p-1 shadow overflow-hidden">
                                        <Card.Body>
                                            <div className="chart-block my-auto">
                                                <div className="text-center">
                                                    <i className="fal fa-exclamation-triangle fa-3x mb-3 text-danger" />
                                                    <h5 className="text-danger">This feature is not available for your package</h5>
                                                </div>
                        ...
                        <Col xl={6} lg={6} md={12} className="my-3">
                            {isuserValid.ra_qtype == false ? (
                                <WeakAnalysis
                                    mobile={this.props.mobile}
                                    stateData={this.props.stateData} />
                            ) : (
                                    <Card as={Card.Body} className="p-2 pt-3 border-0 top-weeks shadow">
                                        <Card.Body>
                                            <div className="d-flex align-items-center">
                                                <div className="text-center">
                                                    <i className="fal fa-exclamation-triangle fa-3x mb-3 text-danger" />
                    ...
                    <Row>
                        <Col xl={12} lg={12} md={12} className="question-theory mt-4">
                            {isuserValid.ra_qtheory == false ? (
                                <Card as={Card.Body} className="border-0 question-theory-block overflow-hidden">
                                    <div className="title-block">
                                        <div className="title">Question Theory</div>
                                    </div>
                                    <Row className="ml-5 tables-block">
                                        <Col xl={6} lg={6} md={6} sm={12}>
                                            <Table borderless className="mb-0" size="sm">
                                                <thead>
                                                    <tr>
                                                        <th>Application Questions</th>
                                                        <th>{getAnalytics.getAnalytics.question_theory.application_questions}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>Accuracy</td>
                                                        <td>{getAnalytics.getAnalytics.question_theory.application_accuracy}%</td>
                                                    </tr>
                                                </tbody>
                                            </Table>
                                        </Col>
                                        <Col xl={6} lg={6} md={6} sm={12}>
                                            <Table borderless className="mb-0" size="sm">
                                                <thead>
                                                    <tr>
                                                        <th>Concept Questions</th>
                                                        <th>{getAnalytics.getAnalytics.question_theory.theory_questions}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>Accuracy</td>
                                                        <td>{getAnalytics.getAnalytics.question_theory.theory_accuracy}%</td>
                                                    </tr>
                                                </tbody>
                                            </Table>
                                        </Col>
                                    </Row>
                                    <ul className="list-unstyled list-one">
                                        <li><i class="fas fa-circle"></i></li>
                                        <li><i class="fas fa-circle"></i></li>
                                        <li><i class="fas fa-circle"></i></li>
                                    </ul>
                                    <ul className="list-unstyled list-two">
                                        <li><i class="fas fa-circle"></i></li>
                                        <li><i class="fas fa-circle"></i></li>
                                    </ul>
                                </Card>
