                    ...
                    <Row>
                        <Col xl={12} lg={12} md={12} sm={12}>
                            <div className="text-center">
                                ...
                                <h5 className="text-danger">Notes feature is not available for your package</h5>
                            </div>
            ...
            return (
                <div className="bookmarks_section">
                    <Row className="mt-4 type-wise-list">
                             ...
                             >
                                <Card className="signle_card border-0 shadow-sm h-100">
                                    ...
                                    <Card.Body className="p-3">
                                        <Card.Title className="mb-0">{this.props.getStudentNotesCount.video_count}</Card.Title>
                                    </Card.Body>
                                </Card>
                            </Link>
                        </Col> */}
                        <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            <Card
                                ...
                                onClick={(e) => this.countModalFunction(e, this.props.getStudentNotesCount.short_notes_count, "/student/notes/shortnotes-and-materials")}
                                ...
                                <Card.Body className="p-3">
                                    <Card.Title className="mb-0">{this.props.getStudentNotesCount.short_notes_count}</Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            <Card
                                style={{ cursor: "pointer" }}
                                onClick={(e) => this.countModalFunction(e, this.props.getStudentNotesCount.practice_questions_count, "/student/notes/practice-questions")}
                                className="signle_card border-0 shadow-sm h-100">
                                ...
                                <Card.Body className="p-3">
                                    <Card.Title className="mb-0">{this.props.getStudentNotesCount.practice_questions_count}</Card.Title>
                                </Card.Body>
                            </Card>
                        ...
                        <Col xl={3} lg={3} md={6} sm={6} xs={12} className="mb-3">
                            ...
                            <Card
                                style={{ cursor: "pointer" }}
                                onClick={(e) => this.countModalFunction(e, this.props.getStudentNotesCount.exam_questions_count, "/student/notes/exam-questions")}
                                className="signle_card border-0 shadow-sm h-100">
                                ...
                                <Card.Body className="p-3">
                                    <Card.Title className="mb-0">{this.props.getStudentNotesCount.exam_questions_count}</Card.Title>
                                </Card.Body>
                            </Card>
                    ...
                    <Row className="mt-4">
                        ...
                        {this.props.getStudentNotesCount.notes_subjects_count.map((getData) => (
                            <Col xl={3} lg={3} md={6} sm={6} xs={12}>

                                <Card style={{ cursor: "pointer" }} className="singlecard border-0 shadow-sm"
