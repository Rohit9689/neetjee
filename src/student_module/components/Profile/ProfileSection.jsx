                                                    ...
                                                    <React.Fragment>
                                                        <Row>
                                                            ...
                                                            <Form.Group as={Col} xl={1} lg={1} md={1} sm={1} xs={2} controlId="formBasicBranch">
                                                                <Button className="btn btn-lightblue mt-md-4 w-100" onClick={this.addPost}> <i className="fas fa-plus" /></Button>
                                                            </Form.Group>
                                                        </Row>
                                                        {this.state.userexams.map((userexams, index) => {
                                                            return (
                                                                <Row>
                                                                    ...
                                                                    <Form.Group as={Col} xl={1} lg={1} md={1} sm={1} xs={2} controlId="formBasicBranch">
                                                                        <Button onClick={() => this.handleRemove(index)} className="btn btn-lightred mt-md-4 w-100"> <i className="fas fa-minus" /></Button>
                                                                    </Form.Group>
                                                                </Row>
                                                            )
                                                        })}
                                                            ...
                                                            return (
                                                                <Row>
                                                                    ...
                                                                    {index == 0 ? (
                                                                        ...
                                                                        <Button onClick={() => this.edithandleRemove(index)} className="btn btn-lightred mt-md-4 w-100"> <i className="fas fa-minus" /></Button>
                                                                    </Form.Group>)}
