...
import InnerChapterWeightage from './InnerChapterWeightage';
class ChapterWeightage extends Component {
    ...
    render() {
        ...
        return (
            <Card className={this.typewiseClass()}>
                <Accordion.Header
                    as={Card.Header}
                    eventKey="0"
                    className="bg-white"
                    onClick={() => { this.props.topaccactiveFun("0") }}
                >
                    <Card.Title className="h6 mb-0 px-2">
                        {this.props.topdefaultActiveKey != "0" ? (
                            ...
                            Chapter Grouping, Chapter, Topic, Linkage, Concept / Application Questions Wise Weightage
                        {/* {this.props.type == "link" ? ("Linked Chapter Wise Weightage") : (`${this.props.type} Wise Weightage`)}  */}
                    </Card.Title>
                        ...
                        <Tab.Container id="previous-paper-analysis-tabs" defaultActiveKey="first">
                            ...
                            <Tab.Content>
                                ...
                                <Tab.Pane eventKey="first">
                                    <InnerChapterWeightage
                                        topdefaultActiveKey={this.props.topdefaultActiveKey}
                                        topaccactiveFun={this.props.topaccactiveFun}
                                        singlenormalactionsFormatter3={this.props.singlenormalactionsFormatter3}
                                        singleactionsFormatter3={this.props.singleactionsFormatter3}
                                        difficultactionsFormatter={this.props.difficultactionsFormatter}
                                        actionsFormatter3={this.props.actionsFormatter3}
                                        actionsFormatter2={this.props.actionsFormatter2}
                                        handleModalFunction={this.props.handleModalFunction}
                                        type="Grouping"
                                        getPreviousPaperAnalysis={this.props.getPreviousPaperAnalysis}
                                    />
                                </Tab.Pane>
                                <Tab.Pane eventKey="second">
                                    <InnerChapterWeightage
                                        ...
                                        type="Chapter"
                                        getPreviousPaperAnalysis={this.props.getPreviousPaperAnalysis}
                                        pdefaulteventKey={this.props.pdefaulteventKey} />
                                </Tab.Pane>
