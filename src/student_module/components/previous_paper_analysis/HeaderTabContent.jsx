...
class HeaderTabContent extends Component {
    ...
    render() {
        ...
        let tcombined = [];
        let trueArr = yearnewArray.filter((a) => a.checked == true);
        trueArr = trueArr.sort((a, b) => {
            let nameA = a.year
            let nameB = b.year
        ...
        let falseArr = yearnewArray.filter((a) => a.checked == false);
        falseArr = falseArr.sort((a, b) => {
            let nameA = a.year
            let nameB = b.year
        ...
        tcombined.push(...trueArr);
        tcombined.push(...falseArr);
        yearnewArray = tcombined;
        ...
        let clength = trailRestriction.studentChapters.filter((a) => a.enabled == true && moduleValid.previous_paper_analysis_tab == false || isStudentUserValid.previous_sets.split(",").includes(a.id.toString()));
