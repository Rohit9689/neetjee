...
class SubjectWiseTable extends Component {
    constructor(props) {
        super(props)
        this.state = {
            SubjectWiseTableData: props.SubjectWiseTableData,
            direction: {
                in_time: "asc",
                less_time: "asc",
                over_time: "asc",
    ...
    sortBy = (Key) => {
        ...
        let SubjectWiseTableData = this.state.SubjectWiseTableData
        // if (Key == "chapter_name" || Key == "subject_name") {
        //     SubjectWiseTableData = this.state.SubjectWiseTableData.sort((a, b) => {
        ...
        //}
        this.setState({
            SubjectWiseTableData: SubjectWiseTableData,
            direction: {
                        ...
                        <Table className="mb-0 borderless" responsive>
                            <thead>
                                <tr>
                                    ...
                                    style={{ cursor: "pointer" }} 
                                    aria-hidden="true" 
                                    onClick={() => this.sortBy('speed')} 
                                    />
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                {this.state.SubjectWiseTableData.map((subjectmap) => {
