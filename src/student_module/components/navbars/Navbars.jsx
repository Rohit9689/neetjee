                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <div className="mr-auto d-flex align-items-center">
                            <Button variant="light text-dark mr-2 d-flex align-items-center" onClick={this.props.history.goBack}> <i className="fas fa-long-arrow-alt-left" /> <span className="ml-2 d-none d-md-block">Back</span></Button>
