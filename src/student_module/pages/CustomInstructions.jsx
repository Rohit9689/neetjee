...
class CustomInstructions extends Component {
    backPathFunction() {
        let pathname = "";
        if (this.props.history.location.state.etype == "custom") {
            //pathname = "/student/exams/custom-exam";
            pathname = "/student/exams";
        }
        else if (this.props.history.location.state.etype == "error") {
            // pathname = "/student/exams/error-exam";
            pathname = "/student/exams";
        }
        else if (this.props.history.location.state.etype == "previous") {
            // pathname = "/student/exams/previous-paper-exam";
            pathname = "/student/exams";
        }
        else if (this.props.history.location.state.etype == "adaptive") {
            // pathname = "/student/exams/adaptive-exam";
            pathname = "/student/exams";
        }
        else if (this.props.history.location.state.etype == "schedule") {
            // pathname = "/student/exams/schedule-exam";
            pathname = "/student/exams";
        }
        else if (this.props.history.location.state.etype == "customchapter") {
            // pathname = "/student/get-ready-for-exam/chapter-exam";
            pathname = "/student/get-ready-for-exam";
        }
        else if (this.props.history.location.state.etype == "customcumulative") {
            // pathname = "/student/get-ready-for-exam/cumulative-exam";
            pathname = "/student/get-ready-for-exam";
        }
        else if (this.props.history.location.state.etype == "customgrand") {
            // pathname = "/student/get-ready-for-exam/grand-exam";
            pathname = "/student/get-ready-for-exam";
        }
        else if (this.props.history.location.state.etype == "customsemi") {
            // pathname = "/student/get-ready-for-exam/semigrand-exam";
            pathname = "/student/get-ready-for-exam";
        }
        else if (this.props.history.location.state.etype == "customgetready") {
            pathname = "/student/get-ready-for-exam";
        }
        else if (this.props.history.location.state.etype == "schedulehome") {
    ...
    render() {
        ...
        console.log("CustomInstructions", this.props.history.location.state);
        ...
        const instructions = studentGlobals.studentGlobals.examInstructions.find((a) => a.is_exam == "1");

        return (
            <div className="CustomInstructions header-top">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="159.501" height="37.139" className="logo"
                                ...
                                <g transform="translate(-384.741 -406.553)">
                                    ...
                                    <g transform="translate(445.797 439.343)">
                                        ...
                                        <path fill="#0174D8" d="M1262.2,644.174h-1.4v-.664h3.588v.664h-1.4v3.564h-.785Z"
                                        ...
                                        <path fill="#0174D8" d="M1431.991,643.51h.785v4.228h-.785Z"
                        ...
                        {this.props.history.location.state.etype == "customtable" ? (
                            <Link
                                to={{
                                    ...
                                    state: {
                                        getReadyForExamList: this.props.history.location.state.getReadyForExamList
                                    }
                                }}
                ...
                <div className="bg-white py-3 border-top shadow-sm">
                    <Container>
                        <Row><Col xl={12} lg={12} md={12} className="text-right">

                            {this.props.history.location.state.etype == "custom"
                                || this.props.history.location.state.etype == "error"
                                || this.props.history.location.state.etype == "previous"
                                || this.props.history.location.state.etype == "adaptive"
                                || this.props.history.location.state.etype == "customchapter"
                                || this.props.history.location.state.etype == "customcumulative"
                                || this.props.history.location.state.etype == "customgrand"
                                || this.props.history.location.state.etype == "customsemi"
                                || this.props.history.location.state.etype == "customtable"
                                    ...
                                    <Link
                                        to={{
                                            ...
                                            state: {
                                                ...
                                                type: this.props.history.location.state.type,
                                                stype: "schedule_exam",
                                                exam_paper_id: this.props.history.location.state.sessionid.toString(),
                                                etype: this.props.history.location.state.etype
                                            }
                                        }}
                                        className="btn btn-outline-primary px-5"
