...
class PracticeSubmitback extends Component {
    constructor(props) {
        super(props)
        this.state = {
            modalShow: false
                ...
                <div className="bg-success py-3">
                    <Container fluid className="d-flex justify-content-center align-items-center">
                        ...
                        <div className="my-2 my-md-0 text-center">
                            <h6 className="title mb-0 mr-4 text-white">You have completed successfully</h6>
                        </div>
                    </Container>

                </div>

                <div className="text-center content-box mt-5 d-flex align-items-center justify-content-center" style={{ height: '66vh' }}>
                    <Container fluid>
                        <Row>
                            <Col xl={{ span: 8, offset: 2 }} lg={{ span: 8, offset: 2 }} md={{ span: 10, offset: 1 }} sm={12}>
                                <Image src={require('../../images/success_confirmation.svg')} alt="success-img" width="420" />
                            </Col>
                        </Row>
                    </Container>
                </div>
                    ...
                    <Container>
                        <Row>
                            <Col xl={12} lg={12} md={12} className="text-right">
                                ...
                                <Link onClick={this.props.pcancelFunction} className="btn btn-outline-primary px-5"><i className="fal fa-arrow-left" />
                                    Close</Link>
...
export default PracticeSubmitback
