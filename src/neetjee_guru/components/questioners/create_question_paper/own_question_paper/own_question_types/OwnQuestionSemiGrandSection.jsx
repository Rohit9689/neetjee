...
class OwnQuestionSemiGrandSection extends Component {
    // constructor(props) {
    //     super(props)
    ...
    render() {
        ...
        if (this.props.stateData.examtype == "3" || this.props.stateData.examtype=="6" || this.props.stateData.examtype == "7" || this.props.stateData.examtype == "8") {
           ...
           console.log("totalExamCount3", this.props.globals.exams, this.props.stateData.examtype);
        }
        
        
        
        //console.log("totalExamCount3", totalExamCount3);
        return (
                ...
                <Row>
                    <Col xl={9} lg={9} md={12} sm={12}>
                        ...
                        <ul className="list-unstyled">
                                    ...
                                    <Card.Header className="bg-white">
                                        <Row className="align-items-center">
                                            <Col lg={6} md={12} sm={12}>
                                                ...
                                                <Form.Group className="mb-4" controlId="formCategory">
                                                    <Form.Label>Class for Syllabus Selection</Form.Label>
                                                    <SelectDropDown
                                                        stateData={this.props.stateData.sylabusclassvalue}
                                                        handleChange={this.props.pselecthandleInputChange}
                                                        name="sylabusclass"
                                                        options={this.getClassData()}
                                                        placeholderName={'Class'}
                                                    ...
                                                    <Scrollbars style={{ height: 160 }}
                                                        ...
                                                        <ul className="list-unstyled subject-list m-0">
                                                            <li className="d-flex justify-content-between align-items-center">
                                                                <div className="subName">Botnay</div>
                            ...
                            {this.props.stateData.ownaddedquestions == true && this.props.stateData.ownaddedpercentage > 0 ? (<QuestionComponent
                                globals={this.props}
...
export default withRouter(OwnQuestionSemiGrandSection);
