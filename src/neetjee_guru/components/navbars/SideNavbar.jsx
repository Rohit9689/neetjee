...
class SideNavbar extends Component {
  getAccordianActive = () => {
    switch (this.props.history.location.pathname) {
      // Questions
      case "/questions/create-question-paper":
        return 1;
      case "/questions/question-pattern":
        return 1;
      case "/questions/question-pattern/create-question-pattern":
        return 1;
      case "/questions/manage-question-paper":
        return 1;
      case "/questions/create-question-paper/own-question-paper":
        return 1;
      case "/questions/manage-question-paper/question-paper-result":
        return 1;
      case "/questions/create-question-paper/adaptive-question-paper":
        return 1;
      case "/questions/create-question-paper/create-custom-question-paper":
        return 1;
      case "/questions/create-question-paper/create-custom-question-paper/create-custom-summery":
        return 1;
      case "/questions/our-questions/manage-our-question-paper":
        return 1;
      case "/questions/create-question-paper/error-question":
        return 1;
      case "/questions/create-question-paper/old-public-exam":
        return 1;
      case "/questions/our-questions":
        return 1;

      // settings
      case "/settings/notify-students":
        return 2;
      case "/settings/user-creations":
        return 2;
      case "/settings/package":
        return 2;
      case "/settings/category":
        return 2;
      case "/settings/add-section":
        return 2;
      ...
      case "/settings/groups":
        return 2;
      case "/settings/organization-setup":
        return 2;
      case "/settings/organization-profile":
        return 2;
      case "/settings/promote-students":
        return 2;
      case "/settings/promote-students/promote-class":
        return 2;
      case "/settings/promote-students/promote-exit-class":
        return 2;
  ...
  getActiveClass = link => {
    if (link === this.props.history.location.pathname)
      ...
      "/settings/promote-students/promote-class" &&
      link === "/settings/promote-students"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/settings/promote-students/promote-exit-class" &&
      link === "/settings/promote-students"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/question-pattern/create-question-pattern" &&
      link === "/questions/question-pattern"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/own-question-paper" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/manage-question-paper/question-paper-result" &&
      link === "/questions/manage-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/adaptive-question-paper" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/create-custom-question-paper" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/create-custom-question-paper/create-custom-summery" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/our-questions/manage-our-question-paper" &&
      link === "/questions/our-questions"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/error-question" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/un-answered" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
    else if (
      this.props.history.location.pathname ===
      "/questions/create-question-paper/old-public-exam" &&
      link === "/questions/create-question-paper"
    )
      return "collapse-item active";
  ...
  render() {
    console.log("SideNavBaruserlevel", Cookies.get("userlevel"));
    return (
      <div className="sidebar-nav">
        ...
        >
          <Nav className="navbar-nav">
            <Accordion defaultActiveKey={this.getAccordianActive()}>
              {Cookies.get("userlevel")==1 || Cookies.get("userlevel")==2 || Cookies.get("userlevel")==3?(
                <Nav.Item>
                <Link
                  className={this.getActiveClassTwo("/")}
                  to="/"
                  // to="/questions/manage-question-paper"
                  // className={this.getActiveClassTwo("/questions/manage-question-paper")}
                  onClick={() => this.props.onClick()}
                >
                  <i className="fal fa-fw fa-tachometer-alt"></i> Dashboard
                </Link>
              </Nav.Item>
              ):(
                <React.Fragment>
              ...
              <Accordion.Header as={Nav.Link} eventKey={1} className="HasChild">
                <i className="fal fa-file-spreadsheet"></i> Questioners
              </Accordion.Header>
              <Accordion.Body eventKey={1}>
                <div className="collapse-inner rounded">
                  <Link
                    className={this.getActiveClass(
                      "/questions/create-question-paper"
                    )}
                    to="/questions/create-question-paper"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-file-signature" /> Create Question
                    Papers
                  </Link>
                  {/* <Link
                    className={this.getActiveClass(
                    ...
                    to="/questions/question-pattern"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-file-alt" /> Question Pattern
                  </Link> */}
                  <Link
                    className={this.getActiveClass(
                      "/questions/manage-question-paper"
                    )}
                    to="/questions/manage-question-paper"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-file-contract" /> Manage Exams

                  </Link>
                  {/* <Link
                    className={this.getActiveClass("/questions/our-questions")}
                    to="/questions/our-questions"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-file-medical" /> Own Questions
                  </Link> */}
                </div>
              </Accordion.Body>
              <Accordion.Header as={Nav.Link} eventKey={2} className="HasChild">
                <i className="fal fa-cogs"></i> Settings
              </Accordion.Header>
              <Accordion.Body eventKey={2}>
                <div className="collapse-inner rounded">
                  <Link className={this.getActiveClass("/settings/user-creations")} to="/settings/user-creations" onClick={() => this.props.onClick()}><i className="fal fa-user" /> User Creations</Link>
                  <Link className={this.getActiveClass("/settings/notify-students")} to="/settings/notify-students" onClick={() => this.props.onClick()}><i class="fal fa-bell"></i> Notify Students</Link>
                  <Link
                    className={this.getActiveClass("/settings/package")}
                    to="/settings/package"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-box" /> Package
                  </Link>
                  <Link
                    className={this.getActiveClass("/settings/category")}
                    to="/settings/category"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-album-collection" /> Categories
                  </Link>
                  <Link
                    className={this.getActiveClass("/settings/branches")}
                    to="/settings/branches"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fas fa-building" /> Branches
                  </Link>
                  <Link
                    className={this.getActiveClass("/settings/add-section")}
                    to="/settings/add-section"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-layer-group" /> Section
                  </Link>
                  <Link
                    className={this.getActiveClass("/settings/teachers")}
                    to="/settings/teachers"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-user-tie" /> Faculties
                  </Link>
                  <Link
                    className={this.getActiveClass("/settings/students")}
                    to="/settings/students"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-book-reader" /> Students
                  </Link>
                  <Link
                    className={this.getActiveClass("/settings/groups")}
                    to="/settings/groups"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-users" /> Groups
                  </Link>
                  <Link
                    className={this.getActiveClass(
                      "/settings/organization-setup"
                    )}
                    to="/settings/organization-setup"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-building" /> Organization Setup
                  </Link>
                  <Link
                    className={this.getActiveClass(
                    ...
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-container-storage" /> Organization
                    Profile
                  </Link>
                  {/* <Link
                    className={this.getActiveClass(
                      "/settings/promote-students"
                    )}
                    to="/settings/promote-students"
                    onClick={() => this.props.onClick()}
                  >
                    <i className="fal fa-clipboard-check" /> Promote Students
                  </Link> */}
                </div>
              </Accordion.Body>
              {/* <Nav.Item>
                            <Link className={this.getActiveClassTwo("/settings")} to="/settings" onClick={()=>this.props.onClick()}>
        ...
        {/* <div className="sidebar-nav-footer p-3">
                    <Link className="logout" to="/" onClick={() => this.props.onClick()}><i className="fal fa-sign-out-alt icon" /> Logout </Link>
                </div> */}
      </div>
    );
  }
