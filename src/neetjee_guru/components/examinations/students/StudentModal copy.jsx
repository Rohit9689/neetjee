...
class StudentModal extends Component {
  ...
  render() {
    ...
    let globalfiltterSections = this.props.globals.globalSections.filter((item) => {
      ...
      if (item.package_id == this.state.package) {
        return { ...item }
      }
    }
            ...
            <Row>
              ...
              >
                ...
                >
                  ...
                  {this.props.globals.globalSections.map(sectiondata => (
                    <React.Fragment>
                      {this.state.branch == sectiondata.branch_id
                        && this.state.category == sectiondata.category_id
                        && this.state.package == sectiondata.package_id ? (
                        ...
                        (this.state.branch == sectiondata.branch_id &&
                          (this.state.category == sectiondata.category_id || this.state.package == sectiondata.package_id)) ||
                          (this.state.category == sectiondata.category_id &&
                            (this.state.branch == sectiondata.branch_id || this.state.package == sectiondata.package_id)) ||
                          (this.state.package == sectiondata.package_id &&
                            (this.state.branch == sectiondata.branch_id || this.state.category == sectiondata.category_id))
                          ? (
