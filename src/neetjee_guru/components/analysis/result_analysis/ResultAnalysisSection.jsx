                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col xl={2} lg={6} md={6} sm={6} xs={6} className="my-3 order-xl-1 order-2">
                            <Card className="overall-accureny border-0 h-100"
                                ...
                                onClick={() => this.props.tabwisedefaultActiveKeyFun("second")}
                            >
                        ...
                        <Col xl={8} lg={12} md={12} sm={12} xs={12} className="my-3 order-xl-2 order-1">
                            <Card as={Card.Body}
                                style={{ cursor: "pointer" }}
                                onClick={() => this.props.tabwisedefaultActiveKeyFun("third")}
                                className="p-2 pt-3 subject-accureny border-0">
                                <div className="title-block">
                        ...
                        <Col xl={2} lg={6} md={6} sm={6} xs={6} className="my-3 order-xl-3 order-3">
                            ...
                            <Card className="timeAnalysis border-0 h-100"
                                style={{ cursor: "pointer" }}
                                onClick={() => this.props.tabwisedefaultActiveKeyFun("four")}>
                    ...
                    <Row className="complexity-accuracy">
                        <Col xl={6} lg={6} md={12} className="my-3">
                            <Card as={Card.Body}
                                style={{ cursor: "pointer" }}
                                onClick={() => this.props.tabwisedefaultActiveKeyFun("five")}
                                className="pt-3 complexity-accuracy-table border-0 p-1 shadow overflow-hidden">
                                <div className="indicator">
                                    <i className="fas fa-expand-arrows-alt"></i> Expand to view more
                        </div>
                        ...
                        <Col xl={6} lg={6} md={12} className="my-3">
                            <Card
                                style={{ cursor: "pointer" }}
                                onClick={() => this.props.tabwisedefaultActiveKeyFun("seven")}
                    ...
                    <Row>
                        <Col xl={12} lg={12} md={12} className="question-theory mt-4">
                            <Card
                                as={Card.Body} className="border-0 question-theory-block overflow-hidden">
                                <div className="title-block">
