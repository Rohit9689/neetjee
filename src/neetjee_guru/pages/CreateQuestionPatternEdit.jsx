...
import CreateQuestionPatternSectionEdit from "../components/questioners/question_pattern/CreateQuestionPatternSectionEdit";
import Footer from "../components/footer/Footer";
import * as Cookies from "es-cookie";

class CreateQuestionPatternEdit extends Component {
  menuToggler = () => {
        ...
        <div className="content-page">
          ...
          <div className="main-content">
            <CreateQuestionPatternSectionEdit
              editData={this.props != undefined ? this.props : ""}
            />
          </div>
          <Footer />
        </div>
...
export default CreateQuestionPatternEdit;
