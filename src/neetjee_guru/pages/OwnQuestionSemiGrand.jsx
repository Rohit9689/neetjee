...
import OwnQuestionSemiGrandSection from '../components/questioners/create_question_paper/own_question_paper/own_question_types/OwnQuestionSemiGrandSection';
...
const GROUPEMIGRANDCOUSTOMGENERAL_PAPER = gql`
  mutation(
    $params:GroupSemiGrandPaper ,
    $time_duration: Int
    $question_count: [SubjectQuestionCount] 
    ) {
        createGroupSemiGrandPaper(
        params: $params,
...
`;
class OwnQuestionSemiGrand extends Component {
    constructor(props) {
        super(props)
        this.state = {
            currentStep: 1,
            ...
            otherexamvalue: "",
            sylabusclass: "1",
            sylabusclassvalue: { value: "1", label: "XI" },
            exam_name: "",
            examtypevalue: "",
            examtype: "",
            branch: "",
    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            // },
            // class: this.props.history.location.state.getGroupData.groupsData.class_ids
        });
    }
    ...
    handleFormSubmit = e => {
        ...
        creategeneralpaper = {
            ...
            exam_class_id: parseInt(this.state.sylabusclass),
        ...
        await this.props.creategroupsemigrandgeneralpaperfun({
            ...
            update: (store, { data }) => {
                ...
                this.setState({
                    ...
                    filename: data.createGroupSemiGrandPaper.filename,
                ...
                this.props.history.push({
                    ...
                    state: {
                        ...
                        exam_paper_id: data.createGroupSemiGrandPaper.exam_paper_id,
                        exam_questions: data.createGroupSemiGrandPaper.exam_questions,
    ...
    // SetpageLoad1 = (data) => {
    //     console.log("this.state.buttonstatusss", this.state.buttonstatus);
    //     if (this.state.buttonstatus == "shedule") {
    //         this.props.history.push({
    //             pathname: "/questions/create-question-paper/own-question-paper/questionsPreview",
    //             state: {
    ...
    validateField(fieldName, value) {
        ...
        let sylabusclassValid = this.state.sylabusclassValid;
        ...
        switch (fieldName) {
            ...
            case "sylabusclass":
                if (value.length == "") {
                    sylabusclassValid = false;
                    fieldValidationErrors.sylabusclass = "class Cannot Be Empty";
                } else {
                    sylabusclassValid = true;
                    fieldValidationErrors.sylabusclass = "";
                }
        ...
        this.setState(
            {
                ...
                sylabusclassValid: sylabusclassValid,
...
export default withRouter(
    compose(
        graphql(GROUPEMIGRANDCOUSTOMGENERAL_PAPER, {
            name: "creategroupsemigrandgeneralpaperfun"
        }),
