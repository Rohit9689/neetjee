...
import GetReadyExamHistorySection from '../components/get_ready_for_exam/history/GetReadyExamHistorySection';
...
class GetReadyExamHistory extends Component {
    render() {
