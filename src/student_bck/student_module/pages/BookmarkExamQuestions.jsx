...
import BookmarkPracticeQuestionsSection from '../components/bookmarks/practice_questions/BookmarkPracticeQuestionsSection'
...
class BookmarkPracticeQuestions extends Component {
    constructor(props) {
        super(props)
        let tagid = "";
    ...
    render() {
        console.log("this.props.history.location.state.tagid", this.props.history.location.state.tagid);
