                                        ...
                                        <Row>
                                            <Col xl={5} lg={5} md={5} sm={12} xs={12}>
                                                ...
                                                <Form>
                                                    ...
                                                    {this.state.loader == 1 ? (
                                                        <Button className="btn btn-green" type="submit" block disabled style={{ width: "" }}>
                                                            <span className="spinner-border spinner-border-sm"></span>
                                                            logging..
                                                      </Button>
                                                    ) : (
                                                            <Button onClick={this.handleFormSubmit} variant="primary" type="submit" block>
                                                                Login
                                                            </Button>
                                                        )}
                                            ...
                                            <Col xl={7} lg={7} md={7} sm={12} xs={12}>
                                                <Image src={require('../../images/login-block-img.svg')} alt="img" fluid />
                                            </Col>
                                        </Row>
                                    </Card>
                                </Col>
