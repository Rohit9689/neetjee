            ...
            <section className="student_login">
                <Container>
                    <div className="student_block">
                        <div className="d-flex flex-column flex-lg-row align-items-center p-3 px-lg-4 mb-3 mb-auto">
                            <Link className="my-0 mr-lg-auto" to="/student/home">
                                {/* <Image src={require('../../images/logo.svg')} width="100" alt="logo" /> */}
                                <svg xmlns="http://www.w3.org/2000/svg" width="130.501" height="37.139"
                            ...
                            <nav className="top-navbar ml-md-3 my-2 my-md-2 mx-md-auto">
                                <Link className="p-2" to="/student/login"><i className="mr-1 fal fa-sign-in-alt" /> Login</Link>
                                {this.state.stepStatus == 0 ? (<Link className="p-2" to="/student/register"><i className="mr-1 fal fa-user-plus" /> Register</Link>) : ("")}

                                <Link className="p-2" to="#"><i className="mr-1 fal fa-hands-helping" /> Tools &amp; Help</Link>
                                <Link className="p-2" to="#"><i className="mr-1 fal fa-question-circle" /> Support</Link>
                            </nav>
                            <p className="text-light mb-0">{this.state.date}</p>
                        </div>
                        <main role="main">
                            <Row>
                                <Col xl={{ span: 8, offset: 2 }} lg={{ span: 8, offset: 2 }} md={12} sm={12} xs={12}>
                                    <h4 className="heading text-white">Welcome to ELAPP.</h4>
                                    <p className="sub-title text-white">The Best competitive exam preparation<br /> portal in the world.</p>
                                </Col>
                                <RegisterSection PstepStatusFun={this.stepStatusFun} />
                            </Row>
                        </main>
                        ...
                        {/* <main role="main">
                            <Row>
                                <Col xl={{ span: 8, offset: 2 }} lg={{ span: 8, offset: 2 }} md={12}>
                                    ...
                                    <p className="sub-title text-white">The Best comparative exam preparation<br /> portal in the world.</p>
                                </Col>
                                <Col xl={{ span: 8, offset: 2 }} lg={{ span: 8, offset: 2 }} md={12}>
                                    ...
                                    <Card as={Card.Body} className="form_footer pt-5 d-flex flex-row justify-content-between border-0 mx-4">
                                        <Button onClick={this.handleFormSubmit} variant="success" type="submit" className="px-4"> Submit </Button>
                                        <Link className="registerlink" to="/student/login"><i className="mr-1 fal fa-sign-in-alt" />Login</Link>
                                    </Card>
                                </Col>
                            </Row>
                        </main> */}
                        <footer className="student_footer mt-auto">
                            <div className="inner pb-2 text-center">
                                <ul className="list-inline m-0">
                                    <li className="list-inline-item mx-2"><Link to="#" className="text-blue"><i className="fab fa-facebook"></i></Link></li>
                                    <li className="list-inline-item mx-2"><Link to="#" className="text-blue"><i className="fab fa-twitter"></i></Link></li>
                                    <li className="list-inline-item mx-2"><Link to="#" className="text-blue"><i className="fab fa-linkedin-in"></i></Link></li>
                                    <li className="list-inline-item mx-2"><Link to="#" className="text-blue"><i className="fab fa-instagram"></i></Link></li>
                                </ul>
                                <p className="m-0">&copy; <Link to="/student/home" className="text-dark">ELAPP</Link> , 2020. All Rights Reserved. Version : 0.1 </p>
                            </div>
                        </footer>
                    </div>
                </Container>
                <div className="LayerCurve">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2645 861" width="2645" height="861">
                        <path fill="#ffffff" d="M2645 861L2645 -0.06C896 51.94 0 805.05 0 861L2645 861Z" />
                    </svg>
                </div>
            </section>
        )
