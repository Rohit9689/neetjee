                        ...
                        <Table className="mb-0 borderless" responsive>
                            <thead>
                                <tr>
                                    <th></th>
                                    {/* <th>Total</th> */}
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (
                                            <th
                                                className={this.subjectThemefun(subjectmap.id)}
                                            >
                                                <div className="icon">
                                                    {this.subjectIconfun(subjectmap.id)}
                                                </div>
                                                <div className="mt-1">{subjectmap.subject}</div>
                                            </th>
                                        )
                                    })}
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                     ...
                                     */}
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        console.log("subjectmap1", subjectmap);
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{parseInt(subjectmap.correct) + parseInt(subjectmap.wrong) + parseInt(subjectmap.not_answered)}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{parseInt(subjectmap.correct) + parseInt(subjectmap.wrong)}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.not_answered}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.correct}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.wrong}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{parseInt(subjectmap.correct) * parseInt(subjectmap.pMarks)}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{parseInt(subjectmap.wrong) * parseInt(subjectmap.nMarks)}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.accuracy}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{this.minutesTimer(subjectmap.total_time)}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                        let avg = "0";
                                        if (subjectmap.total_time != 0) {
                                            let avgcount = Math.round(parseInt(subjectmap.total_time) / (parseInt(subjectmap.correct) + parseInt(subjectmap.wrong)));
                                        ...
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{avg}</td>)
                                    })}
                                </tr>
                            </tbody>
                        </Table>
                    ...
                    <Card className="my-3 totalgrand-table shadow">
                        <Table className="mb-0 borderless" responsive>
                            ...
                            <tbody>
                                ...
                                {getStudentExamSessions.getStudentExamSessions[0].subject_report.map((subjectmap) => {
                                    console.log("subjectmap2", subjectmap);
                                    return (
                                        <tr>
                                            <td>
                                                <div className="d-flex">
                                                    ...
                                                    <span className="ml-2">{subjectmap.subject}</span>
                                                </div>
                                            </td>

                                            <td>{subjectmap.in_time}</td>
                                            <td>{subjectmap.less_time}</td>
                                            <td>{subjectmap.over_time}</td>
                                            <td>{subjectmap.accuracy}%</td>
                                            <td>{subjectmap.speed != null ? (subjectmap.speed) : ("0")} Sec/Q</td>
                                        </tr>
                                    )
                                })}
                            </tbody>
                    ...
                    <Card className="h-100 questiontypeanalysis-table shadow">
                        ...
                        <Card.Body className="p-0">
                            <Table className="mb-0 borderless" responsive>
                                ...
                                <tbody>
                                    {getStudentExamSessions.getStudentExamSessions[0].qtype_report.map((smap) => {
                                        let avg = "0";
                        ...
                        <Card.Body className="p-3">
                            <div className="observation-list" style={{height:150, overflowY:"scroll"}}>
                                <ul className="m-0 p-0 list-unstyled">
                                    <li>Your are week in <strong>diagram</strong> type question making wrong.</li>
                    ...
                    <Card className="chapterwise-table shadow">
                        ...
                        <Card.Body className="p-0">
                            <Table className="mb-0 borderless table-fixed" responsive>
                                <thead>
                                    <tr>
                                        <th className="col-2">Chapter</th>
                                        <th className="col-2 text-danger">Subject</th>
                                        <th className="col-2"><i className="fas fa-fw fa-badge-percent theme-info" />Accuracy</th>
                                        <th className="col-2"><i className="fas fa-fw fa-check-circle text-success" /> Correct</th>
                                        <th className="col-2"><i className="fas fa-fw fa-times-circle text-danger" /> Error</th>
                                        <th className="col-2"><i className="fas fa-fw fa-align-slash theme-purple" /> Not Answered</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {chapter_report.map((chmap) => {
                                        return (
                                            <tr>
