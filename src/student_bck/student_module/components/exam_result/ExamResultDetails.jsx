...
class ExamResultDetails extends Component {
    constructor(props) {
        super(props)
        let direction={};
        props.ExamResultDetailsData.map((item)=>{
            direction=  {...direction, [`${item.subject}`]:"asc"}
        })
        this.state = {
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
                                        ...
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.Total_Questions}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.Answered}</td>)
                                    })}
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.Correct_Marks}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.Wrong_Marks}</td>)
                                    })}
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    {/* <td>15</td> */}
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.Total_Time}</td>)
                                    })}
                                </tr>
                                <tr>
                                    ...
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
                                        ...
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.Average}</td>)
                                    })}
                                </tr>
                            </tbody>
                        </Table>
