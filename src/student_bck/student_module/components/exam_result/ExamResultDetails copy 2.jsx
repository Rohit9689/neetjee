...
class ExamResultDetails extends Component {
    constructor(props) {
        super(props)
        this.state = {
            ExamResultDetailsData: props.ExamResultDetailsData,
            direction: {
                chapter_name: "asc",
                subject_name: "asc",
                accuracy: "asc",
    ...
    sortBy = (Key) => {
        ...
        let ExamResultDetailsData = this.state.ExamResultDetailsData
        if (Key == "chapter_name" || Key == "subject_name") {
            ExamResultDetailsData = this.state.ExamResultDetailsData.sort((a, b) => {
        ...
        this.setState({
            ExamResultDetailsData: ExamResultDetailsData,
            direction: {
                        ...
                        <Table className="mb-0 borderless" responsive>
                            <thead>
                                <tr>
                                    <th></th>
                                    {/* <th>Total</th> */}
                                    {this.state.ExamResultDetailsData[0].subwise.map((subjectmap) => {
                                        return (
                                            <th
                            ...
                            <tbody>
                                {this.state.ExamResultDetailsData.map((map)=>{
                                    return(
                                        <tr>
                                    <th><i className="fas fa-fw" /> {map.type}</th>
                                    {map.subwise.map((subjectmap) => {
                                        console.log("subjectmap1", subjectmap);
                                        return (<td className={this.subjectThemefun(subjectmap.id)}>{subjectmap.value}</td>)
                                    })}
                                </tr>
                                    )
                                ...
                                {/* <tr>
                                    ...
                                    {this.state.ExamResultDetailsData.map((subjectmap) => {
