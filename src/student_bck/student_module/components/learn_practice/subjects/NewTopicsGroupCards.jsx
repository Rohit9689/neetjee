...
import { Row, Col, Card, Nav, Tab, Media, Dropdown } from "react-bootstrap";
...
class NewTopicsGroupCards extends Component {
  ...
  practiceModal = (getTopics, isuserValid) => {

    if (getTopics.enabled == true) {
  ...
  gotoDashboard = (getTopics, index, isuserValid) => {
  ...
  learningFun = (getTopics, index, isuserValid) => {
              ...
              <Col xl={4} lg={4} md={6} sm={6} xs={12} className="mb-3">
                <Card className="subject-card border-0 h-100 card">
                    ...
                    <Tab.Container id="subject-tabs" defaultActiveKey="first">
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="first">
                          ...
                          {getTopics.enabled == true ? (
                            <div className="card-bottom dashboard">

                              <a
                                onClick={() => this.gotoDashboard(getTopics, index, isuserValid)}
                  ...
                  <p className="text-danger mb-1">Revision Material Views: 200</p> */}
                          ...
                          {getTopics.enabled == true ? (<div className="card-bottom learn">
                            <a
                          ...
                          {/* <Card className="border-success w-100 ml-2">
                              ...
                              {getTopics.enabled == true ? (<Card.Footer className="p-1">
                                <a
                                style={{ fontWeight:"bold" }}
                                  title="Learning"
                                  onClick={() => this.learningFun(getTopics, index, isuserValid)}
                            ...
                            <div className="card-bottom practice">
                              {getTopics.total_questions > 0 ? (
                                <a
                                  ...
                                  onClick={(e) => this.practiceModal(getTopics, isuserValid)}
                                >
                                  Start Practise
                                </a>
                              ) : (
