...
class InnerGroupCards extends Component {
  ...
  render() {
    ...
    console.log("getSubjects.getgetSubjectsthird", getSubjects.getSubjects, this.props.subjectid, this.props.ocid, Cookies.get("mobile"), parseInt(Cookies.get("examid")), parseInt(Cookies.get("classid")));
    let subjectsData = "";
    if (getSubjects.getSubjects != undefined) {
      subjectsData = getSubjects.getSubjects[0].studentChapters[0]

    }
    console.log("ohdsv", subjectsData);
              ...
              {/* <div className="content p-2">
                <div className="card-box d-flex p-1">
                  ...
                  <Card className="border-success w-100 ml-2">
                    ...
                    {this.props.enabled == true ? (<Card.Footer className="p-1">
                      <a
                        style={{ fontWeight: "bold" }}
                        title="Learning"
                        onClick={() => this.learningFun()}
