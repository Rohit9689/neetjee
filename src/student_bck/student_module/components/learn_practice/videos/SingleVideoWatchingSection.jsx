...
class SingleVideoWatchingSection extends Component {
    ...
    render() {
        ...
        console.log("this.state.videosList.pdf_file", this.state.videosList);
                                        ...
                                        <Row className="align-items-end header mb-3" style={{ borderBottom: '1px solid #777373' }}>
                                            ...
                                            <Col xl={8} lg={8} md={12}>
                                                <div className="subheader-content">
                                                    <p className="text-white-50 mb-2">{data.views} Views . {moment.unix(data.created_timestamp).format("YYYY/MM/DD")}</p>
                                                </div>
                                            </Col>
