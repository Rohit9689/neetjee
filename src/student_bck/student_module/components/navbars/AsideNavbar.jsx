...
import AsideNavbarDummy from "./AsideNavbarDummy";
                            ...
                            <Accordion defaultActiveKey={this.getAccordianActive()}>
                                ...
                                {isuserValid.ins_exam_tab == true ? ("") : (<Nav.Item>
                                    <Link className={this.getActiveClass("/student/exams")} to="/student/exams">
                                        <i className="fal fa-clipboard-list-check" title="Exams" /> <span>Custom Exams</span>
                                    </Link>
                                </Nav.Item>)}
                                ...
                                {isuserValid.ins_ready_exam_tab == false || isuserValid.ins_bookmarks_tab == false || isuserValid.ins_notes_tab == false ? (
                                    <React.Fragment>
