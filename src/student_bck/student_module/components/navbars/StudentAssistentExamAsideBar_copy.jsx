...
import ExamResultModal from '../exams/ExamResultModal';
...
class StudentAssistentExamAsideBar extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        console.log("pesection", this.props.stateData.index, "pesectionlength", lqlength);

        //console.log("StudentAssistentExamAsideBar", this.props.stateData);
        return (
            <div id="examAsidebar" className="exam-asidebar">
                ...
                <div className="footer-block pb-3 text-center">
                    <ul className="list-unstyled">
                        {/* <li>
                            <Button variant="light" className="mb-2 px-4" >All Questions View</Button>
                        </li> */}
                        <li>
...
export default withRouter(StudentAssistentExamAsideBar)
