...
class AsideNavbar extends Component {
    ...
    render() {
        ...
        console.log("AsideNavbarisuserValid", isuserValid);
        return (
                ...
                <Scrollbars style={{ height: '80vh' }}
                    ...
                    <Nav className="navbar-nav menu">
                        <Accordion defaultActiveKey={this.getAccordianActive()}>
                            ...
                            {isuserValid.ins_learn_tab == true ? ("") : (<Nav.Item>
                            ...
                            {isuserValid.ins_revision_material_tab == true ? ("") : (<Nav.Item>
                            ...
                            {isuserValid.ins_mock_test == true ? ("") : (<Nav.Item>
                            ...
                            {isuserValid.ins_videos_tab == true ? ("") : (<Nav.Item>
                                <Link className={this.getActiveClass("/student/videos")} to="/student/videos">
                                    <i className="fal fa-video" /> <span>Videos<Image src={gifImage} className="ml-2" alt="New" width="40" /></span>
                                </Link>
                            </Nav.Item>)}


                            {/* <Nav.Item>
                                <Link className={this.getActiveClass("/student/refvideos")} to="/student/refvideos">
                                    <i className="fal fa-video" /> <span>Ref Videos</span>
                                </Link>
                            </Nav.Item> */}

                            <hr className="sidebar-divider" />
                            {isuserValid.ins_exam_tab == true ? ("") : (<Nav.Item>
                                <Link className={this.getActiveClass("/student/exams")} to="/student/exams">
                                    <i className="fal fa-clipboard-list-check" title="Exams" /> <span>Exams</span>
                                </Link>
                            </Nav.Item>)}
                            {isuserValid.ins_analysis_tab == true ? ("") : (
                                <Nav.Item>
                            ...
                            {isuserValid.ins_previous_paper_analysis_tab == true ? ("") : (<Nav.Item>
                            ...
                            {isuserValid.ins_linkage_analysis_tab == true ? ("") : (
                                <Nav.Item>
                            ...
                            <Accordion.Collapse eventKey={2}>
                                <div className="collapse-inner">
                                    {isuserValid.ins_ready_exam_tab == true ? ("") : (<Nav.Item>
                                    ...
                                    {isuserValid.ins_bookmarks_tab == true ? ("") : (<Nav.Item>
                                    ...
                                    {isuserValid.ins_notes_tab == true ? ("") : (<Nav.Item>
                            ...
                            {isuserValid.ins_package_tab == true ? ("") : (<React.Fragment>
                                {Cookies.get("student_userlevel") != 1 ? (<Nav.Item>
                                    <Link className={this.getActiveClass("/student/package")} to="/student/package">
                                        <i className="fal fa-sack" title="Package" /> <span>Package</span>
                                    </Link>
                                </Nav.Item>) : ("")}
                            </React.Fragment>)}
                            {/* <hr className="sidebar-divider" /> */}
                            {isuserValid.ins_doubts_tab == true ? ("") : (
                                <Nav.Item>
                            ...
                            <Nav.Item>
                                <Link className={this.getActiveClass("/student/custom-practise-exam")} to="/student/custom-practise-exam">
                                    <i className="fal fa-clipboard-list-check" title="Custom Practise Exam" /> <span>Custom Practise</span>
                                </Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Link className={this.getActiveClass("/student/exams/total-exams-history")} to="/student/exams/total-exams-history">
                                    <i className="fal fa-history" title="Exams History" /> <span>Exams History</span>
                                </Link>
                            </Nav.Item>
...
export default withRouter((AsideNavbar));
