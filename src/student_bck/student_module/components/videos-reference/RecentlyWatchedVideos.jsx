...
class RecentlyWatchedVideos extends Component {
    ...
    render() {
        ...
        // if(this.props.stateData.class!=0 || this.props.stateData.subject!=0 || this.props.stateData.chapter!=0 || this.props.stateData.topic!=0){
        //     if(this.props.stateData.class!=0){
        //         Data = getRecentlyWatchedVideos.getVideos.videoDetails.videosList.filter((a)=>a.class==this.props.stateData.class);
        //     }
        //     if(this.props.stateData.subject!=0){
        //         Data = getRecentlyWatchedVideos.getVideos.videoDetails.videosList.filter((a)=>a.subject==this.props.stateData.subject);
        //     }
        //     if(this.props.stateData.chapter!=0){
        //         Data = getRecentlyWatchedVideos.getVideos.videoDetails.videosList.filter((a)=>a.chapter==this.props.stateData.chapter);
        //     }
        //     if(this.props.stateData.topic!=0){
        //         Data = getRecentlyWatchedVideos.getVideos.videoDetails.videosList.filter((a)=>a.topic==this.props.stateData.topic);
        //     }

        // }
        console.log("RecentlyWatchedVideos"," variables:", {
            params: {
