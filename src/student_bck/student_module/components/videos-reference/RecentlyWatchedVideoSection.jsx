...
import { recentlyWatchedVideo } from './VideoData';
import './_recentlywatchedvideos.scss'
    ...
    render() {
        ...
        return (
            <div className="recentlywatched-videos">
                {/* <Row className="mb-5">
                    <Col xs={12}>
                        <h5 className="font-weight-bold">Filter Videos</h5>
                    </Col>
                ...
                <Row>
                    <Col xs={12}>
                        <h5 className="font-weight-bold">{this.props.videoData.type} </h5>
                    </Col>
                    <Col xs={12}>
                        {Data.length > 0 ? (
                            <Row>
                                {
                                    Data.map((videoDatamap, index) => {
                                        ...
                                        return (
                                            <Col xl={4} lg={4} md={6} sm={6} xs={12} key={videoDatamap.id} className="my-1">
                                                <Card className="single_video">
                                                    ...
                                                    <Card.Body className="content p-2">
                                                        ...
                                                        {/* <h6 className="topic-text mb-0">{videoDatamap.topicName}</h6> */}
...
export default RecentlyWatchedVideoSection
