                ...
                {Data.length > 0 ? (<React.Fragment>
                    {Data.map((map) => {
                        if (map.videosList.length > 0) {
                            ...
                            //         Data = map.videosList.filter((a)=>a.class==this.props.stateData.class);
                            //     }
                            //     if(this.props.stateData.subject!=0){
                            //         Data = map.videosList.filter((a)=>a.subject==this.props.stateData.subject);
                            //     }
                            //     if(this.props.stateData.chapter!=0){
                            //         Data = map.videosList.filter((a)=>a.chapter==this.props.stateData.chapter);
                            //     }
                            //     if(this.props.stateData.topic!=0){
                            //         Data = map.videosList.filter((a)=>a.topic==this.props.stateData.topic);
                            //     }
                            ...
                            return (<React.Fragment>
                                <Col xl={12} lg={12} md={12}>
                                    <div className="my-3 d-md-flex align-items-center header-titles">
                                        <h5 className="mb-0 font-weight-bold">{map.category} Videos</h5>
                                        <Link
                                            to={{
