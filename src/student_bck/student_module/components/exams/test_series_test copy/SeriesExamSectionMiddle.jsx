...
class ScheduleExamSectionMiddle extends Component {
    ...
    startPracticeFun = () => {
        localStorage.setItem("examstartedId", localStorage.getItem("exam_paper_id"));
    ...
    render() {
        let isessionid="";
        if (this.props.getData.etype == "schedule") {
            isessionid = this.props.getData.exam_paper_id;
        }
        else {
            isessionid = this.props.getData.sessionid;
        }
