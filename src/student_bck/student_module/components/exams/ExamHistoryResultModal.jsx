...
class ExamHistoryResultModal extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    totalPer() {
        let progress = "";
        let arr = this.props.getStudentExamSessions.getStudentExamSessions[0].result_questions
        let some = [];
        ...
        console.log("totalPerprogress",progress,"some:", some,"arr:",arr,"resultarray", this.props.getStudentExamSessions.getStudentExamSessions[0].result_questions);
        return progress;
    }
    currectCount() {
        let arr = this.props.getStudentExamSessions.getStudentExamSessions[0].result_questions
    ...
    accuracy() {
        ...
        let arr1 = this.props.getStudentExamSessions.getStudentExamSessions[0].result_questions
        let some1 = [];
    ...
    render() {
        ...
        console.log("getStudentExamSessions", getStudentExamSessions.getStudentExamSessions[0]);
        let maxHeight = "";
        let overflowY = "";
        if (getStudentExamSessions.getStudentExamSessions[0].qtype_report != undefined) {
        ...
        let dheight = 265;
        let doverflowY = "auto";
        if (getStudentExamSessions.getStudentExamSessions[0].rank != undefined) {
        ...
        const scoredata = parseInt(this.props.getStudentExamSessions.getStudentExamSessions[0].correct_marks) - parseInt(this.props.getStudentExamSessions.getStudentExamSessions[0].negative_marks);
        console.log("subject_report", getStudentExamSessions.getStudentExamSessions[0].subject_report);
        let sampleArray=[];
                        ...
                        <Tab.Pane eventKey="result">
                            ...
                            <Row className="my-2">
                                <Col xl={8} lg={8} md={12} sm={12} className="my-2">
                                    <Card as={Card.Body} className="p-2 status-resport">
