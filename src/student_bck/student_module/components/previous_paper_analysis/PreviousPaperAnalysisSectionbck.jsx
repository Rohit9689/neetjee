...
class PreviousPaperAnalysisSection extends Component {
    ...
    render() {
        console.log("PreviousPaperAnalysisSection", this.state);
                                    ...
                                    <Tab.Content>
                                            ...
                                            <Row>
                                                <Col xl={4} lg={4} md={6} sm={12}>
                                                    <Nav variant="pills" className="flex-row my-2">
                                                        <Nav.Item>
                                                            <Nav.Link
                                                                //onClick={() => this.eventKeyFun("first")}
                                                                eventKey="first"
                                        ...
                                        <Tab.Pane eventKey="first">
                                            ...
                                            <Card className="mt-4 complexity">
                                                <Card.Header className="bg-white">
                                                    <Card.Title className="h6 mb-0 px-2">Complexity</Card.Title>
                                                </Card.Header>
                                                <Card.Body>
                                                    <Row>
                                                    ...
                                                    <Row className="mt-4 subject-wise">
                                                        ...
                                                        {getPreviousPaperAnalysis.getPreviousPaperAnalysis.subjects_weightage.map((smap) => {
                                                            return (<Col xl={6} lg={6} md={6} sm={12}>
                                            ...
                                            <Card className="mt-4 questiontype-wise">
                                                <Card.Header className="bg-white">
                                                    <Card.Title className="h6 mb-0">Question Type</Card.Title>
                                                </Card.Header>
                                                <Card.Body>
                                                    <Row>
                                            ...
                                            <Card className="mt-4 question-theory">
                                                <Card.Header className="bg-white">
                                                    <Card.Title className="h6 mb-0 px-2">Question Theory</Card.Title>
                                                </Card.Header>
                                                <Card.Body>
                                                    <Row>
                                                        <Col xl={12} lg={12} md={12} sm={12}>
                                                    ...
                                                    {/* {getPreviousPaperAnalysis.getPreviousPaperAnalysis.questionTheoryWise.map((item) => {
                                                            return (
                                                                <Col xl={6} lg={6} md={6} sm={12}>
                                                                    <Card className={this.questionTheoryClassFun(item.question_theory)}
                                                                    >
                                                                        <Card.Header className="d-flex align-items-center justify-content-between border-0 shadow-none">
                                                                            <h6 className="card-title mb-0">{item.question_theory} Type Questions</h6>
                                                                        </Card.Header>
                                                                        <Card.Body className="p-2">
                                                                            <Table borderless size="sm" className="mb-0" responsive>
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th>Qstn</th>
                                                                                        {item.year.map((item) => {
                                                                                            return (<th>{item.year.split("-")[0]}</th>);
                                        ...
                                        <Tab.Pane eventKey="second">
                                            ...
                                            <Card className="mt-4 questiontype-wise">
                                                ...
                                                {/* <Card.Body>
                                                    <PreviousPaperDataTable questionTypeComplexity={getPreviousPaperAnalysis.getPreviousPaperAnalysis.questionTypeComplexity} />
                                                </Card.Body> */}
                                                <Card.Body>
                                                    <Row>
                                                        <Col xl={12} lg={12} md={12} sm={12}>
