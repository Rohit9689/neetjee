...
class PreviousPaperAnalysisTopNavbar extends Component {
    ...
    render() {
        ...
        return (
            <div className="previous-paper-analysis-header">
                    ...
                    <Container>
                        <Row>
                            <Col xl={12} lg={12} md={12} sm={12}>
                                <Image src={require('../../../images/previous-paper-analysis.svg')} alt="Get Ready For Exam Image" width="200" />
                        <h5 className="mt-4 title">{this.props.analysistitle}</h5>
                            </Col>
                        </Row>
                    </Container>
                </div>
...
export default withRouter(PreviousPaperAnalysisTopNavbar);